...
const AboutSection = () => {
    ...
    return (
        <section id="about" className="py-20 px-4 mb-30 overflow-x-hidden">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col items-center space-y-8 md:space-y-12">
                    ...
                    <div
                        ref={profileRef}
                        className={`card-tech p-4 w-48 h-48 md:w-64 md:h-64 flex items-center justify-center transition-opacity duration-1000 ${
                        ...
                        <div className="flex flex-col space-y-4 md:hidden">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    className="card-tech p-4 block group hover:scale-105 transition-all duration-300"
                                >
                                    <div className="flex items-center space-x-3">
                                        <div className="bg-primary/20 p-2 rounded-lg group-hover:bg-primary/30 transition-colors flex-shrink-0">
                        ...
                        <div className="hidden md:flex md:justify-center md:gap-4 lg:gap-6">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="card-tech p-4 w-52 lg:w-56 block group hover:scale-105 transition-all duration-300"
                                >
                                    <div className="flex items-center space-x-3">
                        ...
                        <div className="card-tech p-6 md:p-8">
                            <div className="space-y-4 md:space-y-6">
                                ...
                                <div className="space-y-3">
                                    <h3 className="text-base md:text-lg font-semibold text-foreground">Core Technologies</h3>
                                    <div className="flex flex-wrap gap-2">
                                        {["XR/VR", "Unity", "Unreal Engine", "C#", "C++", "Swift", "Python", "JavaScript", "Machine Learning", "Stable Diffusion","Web Development"].map((tech) => (
                                            <span key={tech} className="tech-badge text-xs md:text-sm">
                        {tech}
                      </span>
                                        ))}
                                    </div>
